...
print(filing["data"][0]["accessionNumber"])
```

This requests the most recent Apple 10-K and prints its filing accession number, such as `0000320193-25-000079`. The full `filing` value is a Python dictionary whose `data` list contains the filing metadata you can use to retrieve a section or continue with another SEC API workflow.
